...
const IndexPage = () => (
	<Layout>
		...
		<p className="full-width">
			...
			traditional life. Everything beats to it's own rhythm and we try to respect and work in tandem
			with nature and the local culture and traditions. We capture water from the spring in the
			woods, buy dairy products, honey etc. from the neighbours on other hills, have fruit trees and
			wild flowers as much as you can see. It is so beautifully quiet and away from the craziness of
			the world.
		</p>
		<section className="two-col">
			...
			<div className="text">
				...
				<p>
					...
					place for reflection and introspection. There are not TVs, limited phone signal and not
		...
		<section id="travel" className="full-width">
			...
			<p>
				...
				/ deity in Indian religion) which is connected by train to most of the country. From Deva,
				there are regular busses to Brad which is the nearest town from here. From Brad, there are
				two mini busses daily which will drop you 900m away from our house.
			</p>
			<p>
				Do <a href="#contact">contact us</a> for advice or help with your journey, if you need to.
			</p>
			<p>
				Hitchhiking is also popular in Romania and very feasible and an affordable way to move
				around.
			</p>
			<p>
				<strong>Nearest airports are Sibiu (recommended, 2h drive)</strong> and Cluj Napoca (3h
				drive) and Timisoara (3h drive). Transfer by private car is also possible and much faster
				than public transport, but of course more costly and more polluting. The last 900m to our
				place is on a relatively steep small road and requires 4x4 or it's a nice walk through a
				lovely forest (with a bench mid-way if one you need as rest). We can of course pick you up
				from the bottom of the hill as well, especially if you have luggage.
			</p>
		</section>
		...
		<section className="full-width">
			...
			<p>
				...
				remoteness, this might not be the place for you. There are no known local incidents of wild
				animals endangering humans as far as we and the neighbours know.
			</p>
			<h3>Lots of pets</h3>
			<p>
			...
			<p>
				...
				these will wash our into the forest. Try to bring as little plastic and create as little
				rubbish as possible
			</p>
		</section>
