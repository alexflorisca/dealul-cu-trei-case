	...
	<div id="our-story" className="two-col">
		...
		<div className="text">
			...
			<p>
				...
				on four continents so it was only a matter of time to live closer to nature. We gave up our
				comfy life in Britain, for something that we felt is bringing us closer to our nature and
				life purpose. The wandering around the world gave us the courage to move on with our life
				and do what feels right to our hearts. We're into meditation and yoga, connection with
				nature, hiking and simple life. We are at the early stages of this eco-project, still
